...
def main():
    ...
    folders=[str(x) for x in range(1990,2014)]
    path='/home/matt/Documents/w205/Datascience205/Final Project/mapreduce'
    filenames=['_weeklywage_local.txt','_totalwage_local.txt','_establishments_local.txt','_employment_local.txt']
